...
public class UniversalEnergy
{
    ...
    {
        blockUniCable = new BlockCable(222).setHardness(2.5F).setResistance(2F).setUnlocalizedName("blockUniCable").setCreativeTab(CreativeTabs.tabRedstone).setLightOpacity(0);
    ...
    {
        return world.getBlockId(x, y, z) == 222;
    }
}
